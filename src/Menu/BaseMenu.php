...
namespace Splash\Menu;

use Vansbeck07\Notify\Log;
use Vansbeck07\Os;
use Vansbeck07\Str;
use Splash\Foundation\Kernel;
use Splash\Menu\Traits\Action;
use Splash\Menu\Traits\Pagination;
use Splash\Menu\Traits\Response;
use Splash\Menu\Traits\Session;
use Splash\Menu\Traits\Sms;
 ...
 * @method UserResponseValidator|array|string|bool validate()          Validate the user's response. If it returns false, an invalid input error
