...
trait EloquentPaginator
{
     ...
     * Splash will automatically do that when fetching the items for the specific page.
     *
     * @return Splash\Database\Model|Splash\Database\QueryBuilder|Illuminate\Support\Collection
     */
