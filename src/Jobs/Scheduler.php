...
class Scheduler extends BaseScheduler
{
     ...
     */
    public function getWowOutput()
    {
        return $this->schedulerCommand->getOutput();
    }

    /**
     * Wow console application.
     *
    ...
    /**
     * Splash mock for console.
     *
     * @return \Splash\Foundation\Kernel
     */
    public function getSplash()
    {
        return $this->schedulerCommand->getSplash();
    }

    /**
     * Splash default logger.
     *
     * @return \Vansbeck07\Notify\Log
     */
    public function logger()
    {
        return $this->getSplash()->logger();
    }

    /**
     * Schedule a Wow Command.
     *
    ...
    public function command(string $command, $arguments = null)
    {
        return $this->call(function (string $commandName, $arguments) {
            try {
                $command = $this->getWow()->find($commandName);
