...
if (!function_exists('project_root')) {
    ...
    {
        return Splash\Foundation\Path::toProject($append);
    }
}
...
if (!function_exists('app_path')) {
    ...
    {
        return Splash\Foundation\Path::toApp($append);
    }
}
...
if (!function_exists('config_path')) {
    ...
    {
        return Splash\Foundation\Path::toConfig($append);
    }
}
...
if (!function_exists('resource_path')) {
    ...
    {
        return Splash\Foundation\Path::toResources($append);
    }
}
...
if (!function_exists('public_path')) {
    ...
    {
        return Splash\Foundation\Path::toPublic($append);
    }
}
...
if (!function_exists('storage_path')) {
    ...
    {
        return Splash\Foundation\Path::toStorage($append);
    }
}
...
if (!function_exists('test_path')) {
    ...
    {
        return Splash\Foundation\Path::toTests($append);
    }
}
...
if (!function_exists('vendor_path')) {
    ...
    {
        return Splash\Foundation\Path::toVendor($append);
    }
}
