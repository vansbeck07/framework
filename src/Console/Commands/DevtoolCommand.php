...
use Splash\Console\DevTool\ClassAliasAutoloader;

/**
 * Splash Devtool Command.
...
class DevtoolCommand extends FrameworkCommand
{
    ...
    {
        return [
            'Illuminate\Support\Collection'      => 'Splash\Console\Devtool\Caster::castCollection',
            'Illuminate\Database\Eloquent\Model' => 'Splash\Console\Devtool\Caster::castModel',
        ];
    }
