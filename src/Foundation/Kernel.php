...
use Vansbeck07\Os;
use Vansbeck07\Str;
use Vansbeck07\Utils\HTTP;
use Vansbeck07\Utils\URL;
use Splash\Database\Connections;
use Splash\Database\DB;
use Splash\Menu\Menus;
use Splash\Sms\SmsServiceInterface;
...
class Kernel
{
    ...
    public function fail($error)
    {
        ...
        if ($tel = $this->config('app.admin.tel')) {
            ...
            $sender = !empty($sender) ? $sender : 'Splash';
